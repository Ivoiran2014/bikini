...
// Paramter passing
const shopParameter = document.querySelectorAll('.shop-control');
shopParameter.forEach(shop=> {
    shop.addEventListener('click',() => {
        let imageIndice = productIndex > productInfos.length - 1 ? 0 : productIndex;
        // imageIndice = (imageIndice-1) > 0 ? imageIndice-- : 0;
        console.log(imageIndice);
        window.location.href = "/order.html?index="+imageIndice;
    });
});